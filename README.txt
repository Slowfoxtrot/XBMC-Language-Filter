...
How to Use
----------
1.  Make sure your subtitle.SRT file and your movie are exactly IN SYNC.
...
2.  Run XBMC Language Filter and supply the subtitle.srt file for the
movie you desire to edit.  For Linux, this is by command line only.  An
EDL file will be produced in the same location as the supplied 
subtitle.srt file.
...
detecting, or for any other problems please email me!
